...
import { meadeup1, meadeup2, meadeup3, meadeup4, meadeup5 } from "../image";
...
export default (
    <div>
        <div className="title">
            <h2>MAEDEUP</h2>
            <h4>매듭장인 , 김은영</h4>
            <p>무형문화재 제 13호 매듭장, 김은영</p>
        </div>

        <h3>조화와 완결의 미학, 매듭</h3>
        <p>
            매듭장이란 끈목을 이용해 여러 가지 종류의 매듭을 만들거나 술을 다는 기술을 가진 사람을 말합니다. 끈목은 여러 가닥의 실을 합해서 3가닥 이상의 끈을 엮는 것을 말하며, 술이란 끈이나 매듭의 아래에 장식을 위해 다는 것을 말합니다.
        ...
        <div className="gallery">
            <div className="flx">
                <img src={meadeup1}></img>
                <img src={meadeup2}></img>
            </div>
            <div>
                <img src={meadeup3}></img>
            </div>
            <div className="flx">
                <img src={meadeup4}></img>
                <img src={meadeup5}></img>
            </div>

            {/* <div className="flx">
                <div><img src={meadeup1}></img></div>
                <div><img src={meadeup2}></img></div>
            </div>
            <div className="flx"><img src={meadeup3}></img></div>
            <div className="flx">
                <div><img src={meadeup4}></img></div>
                <div><img src={meadeup5}></img></div>
            </div> */}
        </div>
    </div>
);